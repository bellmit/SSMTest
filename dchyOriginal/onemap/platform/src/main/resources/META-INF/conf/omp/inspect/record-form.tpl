<div class="container-fluid" style="width: 98%;padding: 10px">
    <form class="form-horizontal" id="inpectForm">
		...
		<div class="form-group">
            ...
            <div class="col-xs-4">
                <input type="text" onkeyup="onlyNumber(this)" onblur="onlyNumber(this)" class="form-control" name="actualArea" id="actualArea" placeholder="" value="{{actualArea}}">
            </div>

            <label for="qzgd" class="col-xs-2 control-label text-right">其中耕地（亩）</label>
            <div class="col-xs-4" style="padding-top: 8px;">
                <input type="text" onkeyup="onlyNumber(this)" onblur="onlyNumber(this)" class="form-control" name="farmlandArea" id="farmlandArea" placeholder="" value="{{farmlandArea}}">
            </div>
        </div>
