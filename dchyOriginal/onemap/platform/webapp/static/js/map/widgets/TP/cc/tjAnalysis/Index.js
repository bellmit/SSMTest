...
define(["dojo/_base/declare",
    ...
    "text!static/js/map/widgets/TP/cc/tjAnalysis/analysis-basic-tpl.html",
    "text!static/js/map/widgets/TP/cc/tjAnalysis/analysis-list-item.html",
    ...
    function _init() {
        ...
        $("#ccTjAnalysisTitle").append(_label);
        $("#ccTjAnalysisPanel").append(renderTpl(baseTpl, option));
