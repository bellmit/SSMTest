    ...
    if (!e.WebVideoCtrl) {
        var t = function () {
            ...
            this.I_Login = function (t, r, s, o, i, a) {
                ...
                var r = this.findDeviceIndexByIP(e), s = "", o = "", i = -1, a = 0, c = 0, l = !1, P = {
                    iWndIndex: u,
                    iStreamType: 1,
                    iChannelID: 1,
                    bZeroChannel: !1
                ...
                var r = this.findDeviceIndexByIP(e), s = "", o = "", i = -1, a = 1, c = 0, l = f.dateFormat(new Date, "yyyy-MM-dd"), p = {
                    iWndIndex: u,
                    iStreamType: 1,
                    iChannelID: 1,
                ...
                var r = this.findDeviceIndexByIP(e), s = -1, o = "", i = "", a = -1, c = -1, l = 0, p = f.dateFormat(new Date, "yyyy-MM-dd"), P = {
                    iWndIndex: u,
                    iStreamType: 1,
                    iChannelID: 1,
                ...
                if (-1 != n) {
                    if (re())c.JS_GetOSDTime(t.iWndIndex).then(function (e) {
                        ...
                        var r = c.HWP_GetOSDTime(t.iWndIndex), s = f.dateFormat(new Date(1e3 * r), "yyyy-MM-dd hh:mm:ss");
                        t.success(s)
                    }
                } else t.error && t.error()
                ...
                if (!(0 > r)) {
                    var s = d[r], o = new ue, i = s.szHttpProtocol + s.szIP + ":" + s.iCGIPort + "/" + t, a = {
                        type: "GET",
                        url: i,
                        auth: s.szAuth,
                        success: null,
                ...
                if (f.extend(o, t), -1 != n) {
                    ...
                    if (":" == f.Base64.decode(i.szAuth)[0])var a = f.Base64.decode(i.szAuth).split(":")[1], u = f.Base64.decode(i.szAuth).split(":")[2]; else var a = f.Base64.decode(i.szAuth).split(":")[0], u = f.Base64.decode(i.szAuth).split(":")[1];
            ...
            le.prototype.CGI = {
                ...
                var s = 2 == r.protocol ? "https://" : "http://", o = E(this.CGI.login, s, e, t), i = new ue, a = {
                    type: "GET",
                    url: o,
                    auth: n,
                    success: null,
                ...
                var n = E(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var r = E(this.CGI.getDeviceInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), s = new ue, o = {
                    type: "GET",
                    url: r,
                    auth: e.szAuth,
                    success: null,
                ...
                var r = E(this.CGI.getAnalogChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), s = new ue, o = {
                    type: "GET",
                    url: r,
                    auth: e.szAuth,
                    success: null,
                ...
                var r = E(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort), s = new ue, o = {
                    type: "GET",
                    url: r,
                    auth: e.szAuth,
                    success: null,
                ...
                if (this.getDigitalChannel(e, {
                        async: !1, success: function (e) {
                            ...
                            for (var t = n.$XML(r).find("InputProxyChannel", !0), o = 0, i = t.length; i > o; o++) {
                                var a = t[o], c = n.$XML(a).find("id").eq(0).text(), u = n.$XML(a).find("name").eq(0).text();
                                s[c] = u
                            }
                        }, error: function (e, n) {
                            t.error && t.error(e, n)
                    ...
                    var o = E(this.CGI.getDigitalChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), i = new ue, a = {
                        type: "GET",
                        url: o,
                        auth: e.szAuth,
                        success: null,
                ...
                var n = E(this.CGI.getZeroChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.getPPPoEStatus, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.getUPnPPortStatus, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.getNetworkBond, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.getNetworkInterface, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t), r = E(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t), s = E(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t), o = c.HWP_StartVoiceTalkEx(n, r, s, e.szAuth, e.iAudioType, e.m_iAudioBitRate, e.m_iAudioSamplingRate);
                return o
                ...
                var i = [{}, {pan: 0, tilt: r.iPTZSpeed}, {pan: 0, tilt: -r.iPTZSpeed}, {
                    ...
                    pan: r.iPTZSpeed,
                    tilt: -r.iPTZSpeed
                }, {}, {speed: r.iPTZSpeed}, {speed: -r.iPTZSpeed}, {speed: r.iPTZSpeed}, {speed: -r.iPTZSpeed}, {speed: r.iPTZSpeed}, {speed: -r.iPTZSpeed}], a = "", c = {};
                switch (r.iPTZIndex) {
                    case 1:
                    case 2:
                    case 3:
                ...
                var s = "", o = "", i = r.iChannelID, a = r.iStreamType, c = r.szStartTime.replace(" ", "T") + "Z", u = r.szEndTime.replace(" ", "T") + "Z";
                ...
                var i = E(t.cgi, t.urlProtocol, o, t.iPort, t.iChannelID, r, s), a = c.HWP_ReversePlay(i, e.szAuth, n, r, s);
                if (0 == a) {
                    var u = new ce;
                ...
                var n = -1, r = E(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort), s = "<?xml version='1.0' encoding='UTF-8'?><downloadRequest><playbackURI> " + f.escape(t.szPlaybackURI) + "</playbackURI></downloadRequest>";
                ...
                var n = E(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "PUT",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var r = E(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t), s = new ue, o = {
                    type: "PUT",
                    url: r,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort), r = E(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
                ...
                var n = E(this.CGI.SDKCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var t = 100 * t + 1, s = -1, o = E(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t), i = [];
                ...
                var o = "";
                o = 2 == t ? "https://" : "http://";
                var i = E(this.CGI.sessionCap, o, e, n, encodeURIComponent(r)), a = new ue, c = {
                    type: "GET",
                    url: i,
                    auth: "",
                    success: null,
                ...
                var c = "";
                c = 2 == t ? "https://" : "http://";
                var u = E(this.CGI.sessionLogin, c, e, r), l = n.$XML(i).find("sessionID").eq(0).text(), d = n.$XML(i).find("challenge").eq(0).text(), p = parseInt(n.$XML(i).find("iterations").eq(0).text(), 10), P = !1, h = "";
                ...
                var n = E(this.CGI.sessionHeartbeat, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "PUT",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.sessionLogout, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "PUT",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.systemCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
            ...
            de.prototype.CGI = {
                ...
                var o = 2 == s.protocol ? "https://" : "http://", i = E(this.CGI.login, o, e, t), a = new ue, c = {
                    type: "GET",
                    url: i,
                    auth: r,
                    success: null,
                ...
                var r = E(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), s = new ue, o = {
                    type: "GET",
                    url: r,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.getStreamDynChannels, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new ue, s = {
                    type: "GET",
                    url: n,
                    auth: e.szAuth,
                    success: null,
                ...
                var n = E(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t), r = E(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t), s = E(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t), o = c.HWP_StartVoiceTalkEx(n, r, s, e.szAuth, e.iAudioTypeoDeviceInfo.m_iAudioBitRate, e.m_iAudioSamplingRate);
                return o
                ...
                var o = [{}, {pan: 0, tilt: r.iPTZSpeed}, {pan: 0, tilt: -r.iPTZSpeed}, {
                    ...
                    pan: r.iPTZSpeed,
                    tilt: -r.iPTZSpeed
                }, {}, {speed: r.iPTZSpeed}, {speed: -r.iPTZSpeed}, {speed: r.iPTZSpeed}, {speed: -r.iPTZSpeed}, {speed: r.iPTZSpeed}, {speed: -r.iPTZSpeed}], i = "", a = {};
                switch (r.iPTZIndex) {
                    case 1:
                    case 2:
                    case 3:
                ...
                var n = E(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort), r = "<?xml version='1.0' encoding='UTF-8'?><downloadRequest><playbackURI> " + f.escape(t.szPlaybackURI) + "</playbackURI></downloadRequest>";
                ...
                var s = E(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID), o = new ue, i = {
                    type: "PUT",
                    url: s,
                    data: n,
                    auth: e.szAuth,
                ...
                var t = 100 * t + 1, s = E(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t), o = [];
            ...
            Pe.prototype.extend = function () {
                ...
                var e = /(chrome)[ \/]([\w.]+)/, t = /(safari)[ \/]([\w.]+)/, n = /(opera)(?:.*version)?[ \/]([\w.]+)/, r = /(msie) ([\w.]+)/, s = /(trident.*rv:)([\w.]+)/, o = /(mozilla)(?:.*? rv:([\w.]+))?/, i = navigator.userAgent.toLowerCase(), a = e.exec(i) || t.exec(i) || n.exec(i) || r.exec(i) || s.exec(i) || i.indexOf("compatible") < 0 && o.exec(i) || ["unknow", "0"];
                ...
                return e = function (e) {
                    ...
                    var s, o, i, a, c, u, l, d, p, P, h, I, f = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298], m = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], C = Array(64);
