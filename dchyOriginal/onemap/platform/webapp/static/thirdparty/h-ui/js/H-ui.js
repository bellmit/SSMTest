...
jQuery.Huifold = function(obj,obj_c,speed,obj_type,Event, callback){
	if(obj_type == 2){
		$(obj+":first").find("b").html('<i class="Hui-iconfont Hui-iconfont-arrow2-top"></i>');
		$(obj_c+":first").show();
	}			
	$(obj).on(Event,function(){
		if($(this).next().is(":visible")){
			if(obj_type == 2){
				...
				if($(this).find("b")){
					$(this).find("b").html('<i class="Hui-iconfont Hui-iconfont-arrow2-bottom"></i>');
				}
			}
		}
		else{
			if(obj_type == 3){
				...
				if($(this).find("b")){
					$(this).find("b").html('<i class="Hui-iconfont Hui-iconfont-arrow2-top"></i>');
				}
			}else{
				$(obj_c).slideUp(speed);
				$(obj).removeClass("selected");
				if($(this).find("b")){
					$(obj).find("b").html('<i class="Hui-iconfont Hui-iconfont-arrow2-bottom"></i>');
				}
				$(this).next().slideDown(speed).end().addClass("selected");
				if($(this).find("b")){
					$(this).find("b").html('<i class="Hui-iconfont Hui-iconfont-arrow2-top"></i>');
