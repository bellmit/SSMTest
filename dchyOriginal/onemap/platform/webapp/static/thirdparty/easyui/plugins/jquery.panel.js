...
var _7=_6.options;
var _8=_6.panel;
var _9=_8.children(".easyui-panel-header");
var _a=_8.children(".easyui-panel-body");
...
function _15(_16){
$(_16).addClass("easyui-panel-body")._size("clear");
...
_21.removeClass("easyui-panel-body-noborder");
_22.removeClass("panel-footer-noborder");
}else{
_20.addClass("panel-header-noborder");
_21.addClass("easyui-panel-body-noborder");
...
_1(_1d.children(".easyui-panel-header"));
_1d.children(".easyui-panel-body").addClass("easyui-panel-body-noheader");
}else{
if(_1c.header){
$(_1c.header).addClass("easyui-panel-header").prependTo(_1d);
}else{
var _23=_1d.children(".easyui-panel-header");
if(!_23.length){
...
_23.empty();
var _24=$("<div class=\"easyui-panel-title\"></div>").html(_1c.title).appendTo(_23);
if(_1c.iconCls){
...
_1d.children("div.easyui-panel-body").removeClass("easyui-panel-body-noheader");
}
};
...
$(_1a).addClass("easyui-panel-body-nobottom");
}else{
_1d.children(".panel-footer").remove();
$(_1a).removeClass("easyui-panel-body-nobottom");
}
};
};
...
_38.closed=false;
_38.minimized=false;
var _3a=_39.children(".easyui-panel-header").find("a.panel-tool-restore");
if(_3a.length){
_38.maximized=true;
}
_38.onOpen.call(_36);
...
var _4d=_4c.children(".easyui-panel-body");
var _4e=_4c.children(".easyui-panel-header").find("a.panel-tool-collapse");
...
var _54=_53.children(".easyui-panel-body");
var _55=_53.children(".easyui-panel-header").find("a.panel-tool-collapse");
...
var _59=_58.children(".easyui-panel-header").find("a.panel-tool-max");
...
var _62=_61.children(".easyui-panel-header").find("a.panel-tool-max");
...
$(_64).panel("header").find("div.easyui-panel-title").html(_65);
};
var _66=null;
...
return $.data(jq[0],"panel").panel.children(".easyui-panel-header");
},footer:function(jq){
return jq.panel("panel").children(".panel-footer");
},body:function(jq){
return $.data(jq[0],"panel").panel.children(".easyui-panel-body");
...
var t=$(_7c);
var hh=t.children(".easyui-panel-header,header");
var ff=t.children(".panel-footer,footer");
return $.extend({},$.parser.parseOptions(_7c,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("easyui-panel-header"):undefined),footer:(ff.length?ff.removeClass("panel-footer"):undefined)});
};
