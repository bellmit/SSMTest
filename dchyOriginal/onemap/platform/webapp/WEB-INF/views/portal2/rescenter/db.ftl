...
<script type="text/javascript">
    ...
    setTimeout(function(){
        $('#linkDB').click();
        $($('.tree-menu li a')[0]).trigger('click');
    }, 100);
                            ...
                            <div class="accordion-inner">
                                <ul class="nav tree-menu">
                                    ...
                                    <a href="#" data-url="<@com.rootPath/>/portal2/ajax/fetchDetail/${metadata.id}" class="a4d" data-result-ctn="#mapResultCtn">
                                        <i class="icon icon-copy"></i>${metadata.userName}<#if metadata.nd??>_${metadata.nd!}</#if></a>
                                    </li>
                                    </#list>
                                    <#else >
                                    ...
                                    <#--<#list dbList as db>-->
                                        <#--<#assign dbInfo=db.dbInfo/>-->
                                        <#--<li id="${dbInfo.id}" data-has-child="true">-->
                                            <#--<a href="#"><i class="icon icon-hdd"></i><strong>${dbInfo.sjksl}</strong></a>-->
                                        <#--</li>-->
                                        <#--<#if db.jjfa??>-->
                                            <#--<#list db.jjfa as item>-->
                                                <#--<li id="${item.ywlx}" data-parent="${item.slbm}" data-has-child="true">-->
                                                    <#--<a href="#"><i class="icon icon-folder-close"></i>${item.ywlxmc!}</a>-->
                                                <#--</li>-->
                                                <#--<#list item.metadatas as metadata>-->
                                                    <#--<li id="${metadata.id}" data-parent="${metadata.ywlx}" data-has-child="false">-->
                                                        <#--<a href="#" data-url="<@com.rootPath/>/portal2/ajax/fetchDetail/${metadata.id}" class="a4d" data-result-ctn="#mapResultCtn"><i class="icon icon-copy"></i>${metadata.userName}_${metadata.nd}</a>-->
                                                    <#--</li>-->
                                                <#--</#list>-->
                                            <#--</#list>-->
                                        <#--</#if>-->
                                ...
                                <ul class="nav tree-menu">
                                    <#list groups as g>
                                        <li id="${g.id}" data-has-child="true" data-url="<@com.rootPath />/portal2/ajax/fetchMapGroup?parentId=${g.id}">
                                            <a href="#"><i class="icon icon-folder-close"></i><strong>${g.name}</strong></a>
                                        </li>
                                    </#list>
                                </ul>
                            </div>
