...
<div class="container">
    ...
    <div style="float:right;margin-bottom: 10px;margin-top: -40px;margin-right: 20px;">
        ...
        <input type="button" value="新页面查看" onclick="javascript:newGhPage();" style="color:#188074;"/>
    </div>
    <div class="row">
        ...
        <div class="span9">
            <div class="tab-content large">
                <div id="TDYTQInfo" class="tab-pane fade in active"><@com.tdghsc2 key="土地用途分区" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc2></div>
                <div id="JSYDGZQInfo" class="tab-pane fade"><@com.tdghsc2 key="建设用地管制区" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc2></div>
                <#if localVersion?? && localVersion == "heb">
                <#else>
                    <div id="GHJBNTTZInfo" class="tab-pane fade"><@com.tdghsc2 key="规划基本农田调整" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc2></div>
                    <div id="MZZDJSXMInfo" class="tab-pane fade"><@com.tdghsc2 key="重点建设项目" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc2></div>
                </#if>
            </div>
        </div>
    </div>
...
//              close:null
     ...
     */
    function newGhPage() {
        var url = '${path_omp!'/omp'}/geometryService/analysis/tdghsc/newPage';
        _execute(url, {
            result: JSON.stringify(${resultJson!}),
            unit: JSON.stringify(${unitJson!}),
            decimal: JSON.stringify(${decimalSize!}),
    ...
    function gotoLocation(geojson) {
        window.parent.doBottomLoc(geojson);
    }
