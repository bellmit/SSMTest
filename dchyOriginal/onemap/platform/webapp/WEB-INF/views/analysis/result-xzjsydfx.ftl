...
<@aBase.tpl showHeader="false" css=cssContent bootVersion="-v3">
            ...
            <#if result?size gt 0>
                <div class="tab-content col col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <table>
                        ...
                        <#assign xzjsydHj=0, ytjjsydHj=0>
                        <#list result?keys as key>
                            <#assign resultOne=result[key]!>
                            <tr>
                                <td>${resultOne["DKMC"]!}</td>
                                <td>${resultOne["xzjsydmj"]!0}</td>
                                <td>${resultOne["ytjjsqmj"]!0}</td>
                            </tr>
                            <#assign xzjsydHj=xzjsydHj+resultOne["xzjsydmj"]!0, ytjjsydHj=ytjjsydHj+resultOne["ytjjsqmj"]!0>
                        </#list>
                        <tr>
    ...
    <script type="text/javascript">
        ...
        function exportExcel(f) {
            ...
            openPostWindow("<@com.rootPath/>/geometryService/export/analysis", JSON.stringify(data), "xzjsydfx_result.xml");
        }
