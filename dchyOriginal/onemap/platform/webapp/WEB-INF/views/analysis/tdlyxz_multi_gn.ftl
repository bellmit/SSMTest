                ...
                <div id="content${dataRow.year}" class="tab-pane fade in <#if dataRow_index==0>active</#if>">
                    <#if dataRow.reportData??>
                        ...
                        <div class="btn-group pull-right btn-options">
                            <button type="button" class="btn btn-default active" title="分类结果" data-type="basic" data-year="${dataRow.year!}">
                                <span class="icon icon-list icon-large"></span>
                            </button>
                            <button type="button" class="btn btn-default" title="审核对比" data-type="func" data-year="${dataRow.year!}">
                        ...
                        <#if analysisData?size gt 0>
                            ...
                            <div id="basicContainer${dataRow.year!}" class="container basic-container">
                                <div class="row">
                                    <div>
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#tab${dataRow.year!}1" data-toggle="tab">一级分类</a></li>
                                            <li><a href="#tab${dataRow.year!}2" data-toggle="tab">二级分类</a></li>
                                            <#if firstB??>
                                                <#if firstB?keys?seq_contains('农用地') >
                                                    <li><a href="#tab${dataRow.year!}3" data-toggle="tab">三大类</a></li>
                                                </#if>
                                            </#if>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        ...
                                        <div id="tab${dataRow.year!}2" class="tab-pane fade">
                                            <#if firstB??>
                                                <table>
                                                    <tr>
                                                        <th rowspan="3">坐落单位</th>
                                                        <th rowspan="3">合计</th>
                                                        <th rowspan="3">耕地(01)</th>
                                                        <th colspan="6">其中</th>
                                                        <th rowspan="3">园地(02)</th>
                                                        <th colspan="6">其中</th>
                                                        <th rowspan="3">林地(03)</th>
                                                        <th colspan="6">其中</th>
                                                        <th rowspan="3">草地(04)</th>
                                                        <th colspan="6">其中</th>
                                                        <th rowspan="3">城镇村及工矿用地(20)</th>
                                                        <th colspan="10">其中</th>
                                                        <th rowspan="3">交通运输用地(10)</th>
                                                        <th colspan="12">其中</th>
                                                        <th rowspan="3">水域及水利设施用地(11)</th>
                                                        <th colspan="18">其中</th>
                                                        <th rowspan="3">其他用地</th>
                                                        <th colspan="12">其中</th>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="2">水田(011)</th>
                                                        <th colspan="2">水浇地(012)</th>
                                                        <th colspan="2">旱地(013)</th>
                                                        <th colspan="2">果园(021)</th>
                                                        <th colspan="2">茶园(022)</th>
                                                        <th colspan="2">其他园地(023)</th>
                                                        <th colspan="2">有林地(031)</th>
                                                        <th colspan="2">灌木林地(032)</th>
                                                        <th colspan="2">其他林地(033)</th>
                                                        <th colspan="2">天然牧草地(041)</th>
                                                        <th colspan="2">人工牧草地(042)</th>
                                                        <th colspan="2">其他草地(043)</th>
                                                        <th colspan="2">城市(201)</th>
                                                        <th colspan="2">建制镇(202)</th>
                                                        <th colspan="2">村庄(203)</th>
                                                        <th colspan="2">采矿用地(204)</th>
                                                        <th colspan="2">风景名胜及特殊用地(205)</th>
                                                        <th colspan="2">铁路用地(101)</th>
                                                        <th colspan="2">公路用地(102)</th>
                                                        <th colspan="2">农村道路(104)</th>
                                                        <th colspan="2">机场用地(105)</th>
                                                        <th colspan="2">港口码头用地(106)</th>
                                                        <th colspan="2">管道运输用地(107)</th>
                                                        <th colspan="2">河流水面(111)</th>
                                                        <th colspan="2">湖泊水面(112)</th>
                                                        <th colspan="2">水库水面(113)</th>
                                                        <th colspan="2">坑塘水面(114)</th>
                                                        <th colspan="2">沿海滩涂(115)</th>
                                                        <th colspan="2">内陆滩涂(116)</th>
                                                        <th colspan="2">水渠(117)</th>
                                                        <th colspan="2">水工建筑用地(118)</th>
                                                        <th colspan="2">冰川及永久积雪(119)</th>
                                                        <th colspan="2">设施农用地(122)</th>
                                                        <th colspan="2">田坎(123)</th>
                                                        <th colspan="2">盐碱地(124)</th>
                                                        <th colspan="2">沼泽地(125)</th>
                                                        <th colspan="2">沙地(126)</th>
                                                        <th colspan="2">裸地(127)</th>
                                                    </tr>
                                                    <tr>
                                                        <#list 1..38 as i>
                                                        <th>国有</th>
                                ...
                                <div class="export-container text-center">
                                    <a class="btn btn-primary" data-excel='${dataRow.exportXls!}' onclick="exportExcel(this,0);">导出 excel</a>
                                    <#if dataRow.shpId??>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a data-shpid='${dataRow.shpId!}' onclick='exportFeatures(this,0);'>shp压缩包(.zip)</a></li>
                                                <li><a data-shpid='${dataRow.shpId!}' onclick='exportFeatures(this,1);'>cad文件(.dwg)</a></li>
                                            </ul>
                                        </div>
                                    </#if>
                                </div>
