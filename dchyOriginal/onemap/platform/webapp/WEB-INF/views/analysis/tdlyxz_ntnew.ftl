                    ...
                    <#--分析结果展示-->
                            ...
                            <div id="basicContainer${yearItem.year!}" class="container"
                                ...
                                <div style="text-align: center;padding-top: 20px;">
                                    <a class="btn btn-primary" style="margin-right: 12px;"
                                       data-excel='${yearItem.resultStr!}' onclick="exportExcel(this,0);">导出excel</a>
                                    <#if exportable>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a data-shpid='${yearItem.shpId!}' onclick='exportFeatures(this,0);'>shp压缩包(.zip)</a>
                                                </li>
                                                <li><a data-shpid='${yearItem.shpId!}' onclick='exportFeatures(this,1);'>cad文件(.dwg)</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </#if>
                                    <#--<#if exportable><a class="btn btn-primary" data-toggle="tooltip"-->
                                                       ...
                                                       <#--<button class='btn btn-default' onclick='exportFeatures(0,${yearItem.year!});'> shp</button>-->
                                <#--&nbsp;&nbsp;&nbsp;<button class='btn btn-default' onclick='exportFeatures(1,${yearItem.year!});'>dwg</button></div>">导出图形</a></#if>-->
                                </div>
                            </div>
                        <#else>
                        ...
                        <#if report?keys?size gt 0>
                            <div id="funcContainer${yearItem.year!}" class="container func"
                                ...
                                <table class="table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><#if (report.sumResult &gt;0)>
                                            ...
                                            少&nbsp;</#if>${(env.absDouble(report.sumResult))!?string(fixed)}
                                            m<sup>2</sup></td>
                                        <td>${(env.absDouble(report.sumMistake))!?string(fixed)}</td>
                                        <td>${(env.absDouble(compareItemReport.sumMistake))!?string(fixed)}</td>
                                    </tr>
                                    <tr>
                                        <td>集体面积</td>
                                    ...
                                    <#--<td>${report.rJtResult!0}m<sup>2</sup></td>-->
                                        <td><#if (report.rJtResult &gt;0)>
                                            ...
                                            少&nbsp;</#if>${(env.absDouble(report.rJtResult))!?string(fixed)}
                                            m<sup>2</sup></td>
                                        <td>${(env.absDouble(report.jtMistake))!?string(fixed)}</td>
                                        <td>${(env.absDouble(compareItemReport.jtMistake))!?string(fixed)}</td>
                                    </tr>
                                    <tr>
                                        <td>国有面积</td>
                                        ...
                                        <td><#if (report.rGyResult &gt;0)>
                                            ...
                                            m<sup>2</sup></td>
                                        <td>${(env.absDouble(report.gyMistake))!?string(fixed)}</td>
                                        <td>${(env.absDouble(compareItemReport.gyMistake))!?string(fixed)}</td>
                                    </tr>
                                    <tr></tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>${(env.absDouble(report.nydMistake))!?string(fixed)}</td>
                                        <td>${(env.absDouble(compareItemReport.nydMistake))!?string(fixed)}</td>
                                    </tr>
                                    <tr>
                                        <td>其中耕地</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>${(env.absDouble(report.jsydMistake))!?string(fixed)}</td>
                                        <td>${(env.absDouble(compareItemReport.jsydMistake))!?string(fixed)}</td>
                                    </tr>
                                    <tr>
                                        <td>未利用地</td>
                                        ...
                                        <td>${(env.absDouble(report.wlydMistake))!?string(fixed)}</td>
                                        <td>${(env.absDouble(compareItemReport.wlydMistake))!?string(fixed)}</td>
                                    </tr>
                                </table>
                                ...
                                <div style="text-align: center;padding-top: 20px;">
                                    <a class="btn btn-primary" style="margin-right: 12px;"
                                       data-excel='${yearItem.reportXls!}' data-compare='${compareItem.reportXls!}'
                                       data-year='${yearItem.year!}'
                                       onclick="exportExcel(this,1);">导出excel</a>
                                </div>
                            </div>
                        </#if>
                    </div>
...
<script type="text/javascript">
    ...
    function exportExcel(f, type) {
        ...
        var compareData = $(f).data('compare');
        var year = $(f).data('year');
        var reportData = {};
        if (compareData != null) {
            reportData.data = data;
            reportData.compareData = compareData;
            reportData.year = year.toString();
        }
        switch (type) {
            case 0:
                openPostWindow("<@com.rootPath/>/geometryService/export/analysis", JSON.stringify(data), "tdlyxz_nt.xml");
                break;
            case 1:
                openPostWindow("<@com.rootPath/>/geometryService/export/analysis", JSON.stringify(reportData), "tdlyxz_report_nt.xml");
                break;
        }
    }
