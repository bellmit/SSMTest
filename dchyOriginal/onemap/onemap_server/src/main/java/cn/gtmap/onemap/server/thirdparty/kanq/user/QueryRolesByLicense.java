...
@XmlRootElement(name = "QueryRolesByLicense")
public class QueryRolesByLicense {

    @XmlElementRef(name = "license", namespace = "http://service.ser.kanq.com", type = JAXBElement.class)
    protected JAXBElement<String> license;
    @XmlElementRef(name = "type", namespace = "http://service.ser.kanq.com", type = JAXBElement.class)
    ...
    public void setLicense(JAXBElement<String> value) {
        this.license = ((JAXBElement<String> ) value);
    }
