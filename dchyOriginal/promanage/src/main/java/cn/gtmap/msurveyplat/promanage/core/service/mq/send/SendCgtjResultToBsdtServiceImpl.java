 ...
 * @description TODO 推送线上成果提交数据
 */
@Service
public class SendCgtjResultToBsdtServiceImpl implements RabbitTemplate.ConfirmCallback {
