...
import cn.gtmap.msurveyplat.promanage.core.mapper.DchyXmglZdMapper;
...
public class DchyXmglZdServiceImpl implements DchyXmglZdService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DchyXmglZdServiceImpl.class);
    ...
    public DchyXmglZd getDchyXmglByZdlxAndDm(String zdlx, String dm) {
        ...
        if (CollectionUtils.isNotEmpty(dchyXmglZdList) && StringUtils.isNotBlank(dm)) {
            for (DchyXmglZd dchyXmglZd : dchyXmglZdList) {
