	...
	<div style="width: 100%">
		<Form ref="formValidate" class="form-edit" @on-validate="validateChecked" :model="projectInfoData" inline :rules="ruleInline" :label-width='128'>
			...
			<Row>
				...
				<i-col span="12">
					<FormItem label="项目代码 " prop="gcbh">
						<Input :readonly="readonly" placeholder="填写示例: 2019-320412-78-01-570112" style="width: 80%" v-model="projectInfoData.gcbh"/>
					</FormItem>
				</i-col>
			</Row>
			<Row>
				...
				<i-col span="12">
					<FormItem label="项目编号 " prop="BABH">
						<Input :readonly="readonly" style="width: 80%" v-model="projectInfoData.BABH"/>
					</FormItem>
				</i-col>
			</Row>
			<Row>
				...
				<i-col span="12">
					<FormItem label="房屋性质 " prop="FWXZ">
						<RadioGroup v-model="projectInfoData.FWXZ">
							<Radio label="0" :disabled='readonly'>商品房</Radio>
							<Radio label="1" :disabled='readonly'>单位房</Radio>
						</RadioGroup>
					</FormItem>
				</i-col>
			</Row>
					...
					treeList.forEach(tree => {
						if (tree.id == list.FDM) {
							tree.children.push({
                                ...
                                jcrq: list.JCRQ ? list.JCRQ : "",
                                yjjfrq: list.YJJFRQ ? list.YJJFRQ : "",
