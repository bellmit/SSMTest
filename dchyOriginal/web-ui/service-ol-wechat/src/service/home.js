...
export function getAppUserInfo(params) {
    return httpService.get(portalOlContext + "/index/getAppUserMessage?ticket=" + params.ticket)
}
// 获取字典项
...
// 判断是否登录
export function disPatcherCheck(params){
    return httpService.get(portalOlContext + "/login/disPatcherCheck", params)
}