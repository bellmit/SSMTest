...
import { getDictInfo, queryCgInfoList, queryProjectInfo,finishHtbadj, checkFinishStatus, queryDeliverData, isdeleiverData } from "../../service/manage"
...
export default {
    data() {
        return {
            ...
            recordRule: {},
            totalNum: 0,
            operationList: ["view","finish","deliver","viewCgFj"],
            ztList: [],
            cgInfoList: [],
        ...
        deliverDetail(data){
            ...
            isdeleiverData({chxmid: data.CHXMID}).then(res => {
                if(res.data.cgyjf == "1"){
                    ...
                    let url = config.msurveyplatContext + `/pdf/tyjfd/${data.CHXMID}`
