...
layui.use(['jquery','table','element','form','laytpl','response'], function() {
    ...
    $(function () {
        ...
        function getMryj() {
            //获取数据
            $.ajax({
                url: getContextPath() + "/rest/v1.0/shxx/mryj/" + taskId + "?time=" + new Date().getTime(),
        ...
        function getShxxList(mryj) {
            ...
            //获取数据
            $.ajax({
                url: getContextPath() + "/rest/v1.0/shxx/list?" + new Date().getTime(),
                contentType: "application/json;charset=utf-8",
                type: "GET",
                async: false,
        ...
        function processData(data) {
            ...
            $.ajax({
                url: getContextPath() + "/rest/v1.0/workflow/process-instances/getZfqmxs",
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data === 0){
...
function sign(jdmc, shxxid) {
    ...
    //获取数据
    $.ajax({
        url: getContextPath() + "/rest/v1.0/shxx/sign",
        contentType: "application/json;charset=utf-8",
        type: "PUT",
...
function deleteSign(jdmc, shxxid) {
    ...
    // 清除审核意见和签名信息
    $.ajax({
        url: getContextPath() + "/rest/v1.0/shxx/sign/" + shxxid,
        contentType: "application/json;charset=utf-8",
        type: "DELETE",
        // data: JSON.stringify(shxxDO),
        success: function (data) {
...
function updateShxx(param) {
    ...
    $.ajax({
        url: getContextPath() + "/rest/v1.0/shxx/shxxList",
        type: "PATCH",
