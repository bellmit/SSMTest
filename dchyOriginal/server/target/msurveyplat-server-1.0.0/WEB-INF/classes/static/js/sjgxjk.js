layui.use(['table', 'jquery', 'layer', 'form'], function () {
    ...
    $('#add').on('click', function () {
        window.location = 'add.html?event=add'
    });
    ...
    table.on('tool(xmxx)', function (obj) {
        ...
        if (obj.event === "unable") {
            ...
            var url = "add.html?gxywxxid=" + data.GXYWXXID + "&event=detail" + "&loadPage=" + loadPage + "&loadSize=" + loadSize;
            window.location = url;
        } else if (obj.event === "edit") {
            var url = "add.html?gxywxxid=" + data.GXYWXXID + "&event=edit" + "&loadPage=" + loadPage + "&loadSize=" + loadSize;
            window.location = url;
        }
    })
});
