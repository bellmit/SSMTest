    ...
    $(function () {
        ...
        */
        ...
        $buildTask.on('click', '.bdc-carousel-son', function (event) {
            ...
            let wdid = $(this).children('.bdc-carousel-title').attr('data-id');
            $.ajax({
                type: "GET",
                url: getContextPath() + "/index/createTask?wdid=" + wdid,
                success: function (data) {
                    console.log('轮播图Data：', data);
                    var index = window.open("../view/service-page.html?taskid=" + data.taskId + "&xmid=" + data.executionId + "&gzlslid=" + data.processInstanceId + "&formKey=" + data.formKey + "&type=db");
                    newWin.push(index);
                }
            })
        ...
        //var waitUrl = "http://192.168.50.38/index/getTaskList";
        ...
        table.on('rowDouble(waitTableFilter)', function (obj) {
            ...
            var waitCzTimer = setInterval(function () {
                if (sessionStorage.getItem('lcArray' + obj.data.taskId) != null) {
                   ...
                   var index = window.open("../view/service-page.html?taskid=" + obj.data.taskId + "&xmid=" + obj.data.text9 + "&gzlslid=" + obj.data.procInsId + "&formKey=" + obj.data.formKey + "&type=db", "待办任务");
                    newWin.push(index);
                }
            }, 50);
        ...
        table.on('rowDouble(doneTableFilter)', function (obj) {
            ...
            var ybCzTimer = setInterval(function () {
                if (sessionStorage.getItem('lcArray' + obj.data.taskId) != null) {
                    ...
                    var index = window.open("../view/service-page.html?taskid=" + obj.data.taskId + "&xmid=" + obj.data.text9 + "&gzlslid=" + obj.data.procInsId + "&formKey=" + obj.data.formKey + "&type=yb", obj.data.text7);
                    newWin.push(index);
                }
            }, 50);
        });
        ...
        table.on('rowDouble(listTableFilter)', function (obj) {
            ...
            var xmCzTimer = setInterval(function () {
                if (sessionStorage.getItem('listArray' + obj.data.procInsId) != null) {
                    ...
                    var index = window.open("../view/service-page.html?taskid=" + obj.data.taskId + "&xmid=" + obj.data.text9 + "&gzlslid=" + obj.data.procInsId + "&formKey=" + obj.data.formKey + "&type=xm", obj.data.text7);
                    newWin.push(index);
                }
            }, 50);
        });
