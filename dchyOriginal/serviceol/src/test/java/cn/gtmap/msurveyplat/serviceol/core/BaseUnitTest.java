package cn.gtmap.msurveyplat.serviceol.core;

import cn.gtmap.msurveyplat.serviceol.ServiceOlApplication;
import cn.gtmap.msurveyplat.serviceol.core.service.impl.SpringListenerImpl;
 ...
 */
@SpringBootTest(classes = ServiceOlApplication.class)
