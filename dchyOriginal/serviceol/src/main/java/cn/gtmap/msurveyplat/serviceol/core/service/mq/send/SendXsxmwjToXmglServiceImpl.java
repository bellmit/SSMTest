 ...
 */
@Service
public class SendXsxmwjToXmglServiceImpl implements RabbitTemplate.ConfirmCallback {
    ...
    public void confirm(CorrelationData correlationData, boolean ack, String cause) {
        if (ack) {
            ...
            logger.info("**********线上项目文件数据--消息发送失败**********" +
                    Constants.BSDT_XMGL_DIRECT_EXCHANGE + "-" + Constants.BSDT_XMGL_TSWJ_QUEUE +
                    "消息发送时间为:" + CalendarUtil.getCurHMSStrDate());
