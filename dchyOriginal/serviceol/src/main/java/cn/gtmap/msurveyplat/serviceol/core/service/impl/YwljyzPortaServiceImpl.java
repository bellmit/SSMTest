...
@Service
public class YwljyzPortaServiceImpl implements YwljyzService {
    @Autowired
    ...
    public boolean checkInfos(Object object) {
        ...
        for (Iterator itChdwxxList = chdwmcList.iterator(); itChdwxxList.hasNext(); ) {
            if (!chdwmcParam.contains(itChdwxxList.next())) {
                return false;
            }
        }
        return true;
