...
import cn.gtmap.msurveyplat.serviceol.core.service.impl.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/v1.0/**", "/feign/**", "/logout").permitAll()
...
/*    @Bean
    ...
    @Bean
    public FilterRegistrationBean httpAuthFilter() {
        FilterRegistrationBean filterRegistrationBean = new FilterRegistrationBean();
        filterRegistrationBean.setFilter(new ViewAuthFilter());
