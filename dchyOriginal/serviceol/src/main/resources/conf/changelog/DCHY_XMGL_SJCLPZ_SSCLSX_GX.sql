...
--changeset DCHY_XMGL_SJCLPZ_SSCLSX_GX:2 failOnError:false runOnChange:true runAlways:false
comment on column DCHY_XMGL_SJCLPZ_SSCLSX_GX.SJCLPZID is '收件材料配置编号';
--changeset DCHY_XMGL_SJCLPZ_SSCLSX_GX:3 failOnError:false runOnChange:true runAlways:false
