    ...
    $(function () {
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'show'){
                ...
                $tr.after('<tr><td colspan="10"><div class="layui-table-cell">' +
                    '<a class="layui-btn layui-btn-xs bdc-major-btn" onclick="add()">新增</a>' +
                    '<a class="layui-btn layui-btn-danger layui-btn-xs bdc-secondary-btn" onclick="update()">修改</a>' +
                    '<a class="layui-btn layui-btn-danger layui-btn-xs bdc-delete-btn" onclick="deleteTr('+ data.id +')">删除</a></div></td></tr>');
