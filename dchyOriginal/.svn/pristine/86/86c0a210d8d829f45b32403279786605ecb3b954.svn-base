...
@XmlRootElement(name = "getUserByCode")
public class GetUserByCode {

    @XmlElementRef(name = "userCode", namespace = "http://service.ser.kanq.com", type = JAXBElement.class)
    ...
    public void setUserCode(JAXBElement<String> value) {
        this.userCode = ((JAXBElement<String> ) value);
    }
