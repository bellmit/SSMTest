    ...
    <div class='content-header'>
        <div class='header-inner'>
            <div class='header-logo'>
                <div class="home-title">{{placeSevice}}<span class="font-sun">“</span>多测合一<span class="font-sun">”</span>服务平台</div>
                <div class="title-bot-line">{{placePinyin}} "MULTI TEST IN ONE" SERVICE PLATFORM</div>
            </div>
