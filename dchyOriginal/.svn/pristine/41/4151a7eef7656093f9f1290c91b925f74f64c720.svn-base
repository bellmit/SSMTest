<template>
    <div>
        <Form class="form-edit" @on-validate="validateChecked" :model="projectInfo" ref="project-info" :rules="ruleInline" :label-width="114">
                        ...
                        <div class="stage-tree">
                            <div class="select-row-tree select-by-step">
                                <div v-for="(tree,index) in treeList" :key="index">
                                    <Tree ref="tree" @on-check-change="changeClsx" :data="tree" show-checkbox></Tree>
                                </div>
                            </div>
                        </div>
                    </Row>
            ...
            <Row>
                <i-col span="8">
                    <FormItem v-model="projectInfo.xmxz" prop="xmxz" label="项目性质">
                        <RadioGroup v-model="projectInfo.xmxz">
                            <Radio :disabled="readonly" label="1">财政资金项目</Radio>
                            <Radio :disabled="readonly" label="2">社会资金项目</Radio>
                        </RadioGroup>
                    </FormItem>
                </i-col>
                <i-col span="8">
                    <FormItem v-model="projectInfo.slbh" prop="slbh" label="备案编号">
            ...
            <Row>
                ...
                <i-col span="8">
                    <FormItem v-model="projectInfo.xqfbbh" prop="xqfbbh" class="d-line-label" label="关联需求发布编号">
                ...
                <i-col span="8">
                    <FormItem v-model="projectInfo.zdbh" prop="zdbh" label="宗地编号">
                        <Input :readonly="readonly" v-model="projectInfo.zdbh" class="list-form-width"/>
                    </FormItem>
                </i-col>
            </Row>
            <Row>
                <FormItem v-model="projectInfo.gcdzs" prop="gcdd" label="工程地点">
                    ...
                    <Input :readonly="readonly" style="margin-left: 5px;width: 120px" v-model="projectInfo.gcdzxx" />
                </FormItem>
            </Row>
        </Form>
        <div >
