...
<div class="main-operation usel" style="display: none;width:1px;">
    <div id="verticalMenu" class="vertical-operation-menu" style="display: none;width:1px;"></div>
    <div id="popupwin_area" style="display: none;width:1px;"></div>
</div>
<!--左侧面板结束-->


<!--主地图部分开始-->
<div id="map-content" class="usel" style="left:0px;width:100%;">
    <iframe id="show-video" style="width: 50%; height: 100%; position: absolute;" src="/omp/video/rtsp/play?cameraId=${cameraId!}">
    </iframe>
    <div id="scaleInfo" style="display: none;"></div>
...
<!--右侧面板开始-->
<div class="right_panel" style="display: none;width:1px;">
...
<!--地图下方的结果展示面板-->
<div id="result-container" style="display: none;width:1px;">
...
<script type="text/javascript">
    $('#map-content').width($(window).width());
    Pace.start({
        document: true,
        elements: false,
