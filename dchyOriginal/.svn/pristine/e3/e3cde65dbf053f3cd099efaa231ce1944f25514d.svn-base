...
@XmlRootElement(name = "QueryRolesByLicenseResponse")
public class QueryRolesByLicenseResponse {

    @XmlElementRef(name = "return", namespace = "http://service.ser.kanq.com", type = JAXBElement.class)
