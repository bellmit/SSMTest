...
define(["dojo/_base/declare",
    ...
    function _init() {
        ...
        //初始化变量
        $xzjsydAnalysisPanel = $("#NewJSYDAnalysisPanel");
        $xzJsydAnalysis = $("#NewJSYDAnalysisBtn");
        xzJsydAnalysis = new BaseAnalysis(BaseAnalysis.TYPE_NEW_JSYD, _map);
        xzJsydAnalysis.setLinkUrl(_xzjsydConfig.linkUrl);
        xzJsydAnalysis.setModuleConfig(_xzjsydConfig);
    ...
    function _appendList(obj) {
        ...
        $("#jsydList .a-r-btn").unbind();
        $("#jsydList .a-r-btn").on('click', function () {
