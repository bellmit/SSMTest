    ...
    <div class="row">
        ...
        <div class="span9">
            <div class="tab-content large">
                <div id="TDYTQInfo" class="tab-pane fade in active"><@com.tdghsc1 key="土地用途分区" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc1></div>
                <div id="JSYDGZQInfo" class="tab-pane fade"><@com.tdghsc1 key="建设用地管制区" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc1></div>
                <#if localVersion?? && localVersion == "heb">
                <#else>
                    <div id="GHJBNTTZInfo" class="tab-pane fade"><@com.tdghsc1 key="规划基本农田调整" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc1></div>
                    <div id="MZZDJSXMInfo" class="tab-pane fade"><@com.tdghsc1 key="重点建设项目" unit = unit decimal = "${decimal!'####.####'}"></@com.tdghsc1></div>
                </#if>
            </div>
        </div>
    </div>
