...
<#--标题-->
                    ...
                    <#list data as dataRow>
                        <div id="content${dataRow.year}" class="tab-pane fade in <#if dataRow_index==0>active</#if>">
                            ...
                            <#if dataRow.analysisData??>
                                ...
                                <#if showDetail>
                                    <#assign dltbData=dataRow.dltbData>
                                </#if>
                            ...
                            <#--单个年份的分析展示-->
                                <#if analysisData?size gt 0>
                                    ...
                                    <div id="basicContainer${dataRow.year!}" class="container basic-container">
                                        <div class="row">
                                            <div>
                                                <input type="hidden" id="flSxzt" value="all"/>
                                                <ul class="nav nav-tabs">
                                                    <li class="dropdown active yjfl"><a id="tab${dataRow.year!}1"
                                                                                        href="#"
                                                                                        class="dropdown-toggle"
                                                                                        data-toggle="dropdown">一级分类<b
                                                                    class="caret"></b></a>
                                                        <#--<li class="active"><a href="#tab${dataRow.year!}1" data-toggle="tab">一级分类</a>-->
                                                        <ul class="dropdown-menu" role="menu"
                                                            aria-labelledby="tab${dataRow.year!}1">
                                                            <li class="active"><a href="#tab${dataRow.year!}1qb"
                                                                                  tabindex="-1" data-toggle="tab">全部</a>
                                                            </li>
                                                            <li><a href="#tab${dataRow.year!}1gy" tabindex="-1"
                                                                   data-toggle="tab">国有</a></li>
                                                            <li><a href="#tab${dataRow.year!}1jt" tabindex="-1"
                                                                   data-toggle="tab">集体</a></li>
                                                        </ul>
                                                    </li>
                                                    <#--<li><a href="#tab${dataRow.year!}2" data-toggle="tab">二级分类</a></li>-->
                                                    <li class="dropdown "><a id="tab${dataRow.year!}2" href="#"
                                                                             class="dropdown-toggle"
                                                                             data-toggle="dropdown">二级分类<b
                                                                    class="caret"></b></a>
                                                        <ul class="dropdown-menu" role="menu"
                                                            aria-labelledby="tab${dataRow.year!}2">
                                                            <li><a href="#tab${dataRow.year!}2qb" tabindex="-1"
                                                                   data-toggle="tab">全部</a></li>
                                                            <li><a href="#tab${dataRow.year!}2gy" tabindex="-1"
                                                                   data-toggle="tab">国有</a></li>
                                                            <li><a href="#tab${dataRow.year!}2jt" tabindex="-1"
                                                                   data-toggle="tab">集体</a></li>
                                                        </ul>
                                                    </li>
                                                    <#if firstB??>
                                                        <#if firstB?keys?seq_contains('农用地') >
                                                            <li><a href="#tab${dataRow.year!}3"
                                                                   data-toggle="tab">三大类</a>
                                                            </li>
                                                        </#if>
                                                    </#if>
                                                    <#if showDetail>
                                                        <li><a href="#tab${dataRow.year!}4"
                                            ...
                                            <div class="tab-content">
                                                <div id="tab${dataRow.year!}1qb" class="tab-pane fade in active">
                                                    <#if firstA??>
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                ...
                                                <div id="tab${dataRow.year!}1gy" class="tab-pane fade">
                                                    <#if firstA??>
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                            ...
                                                            <#list analysisData as xzq>
                                                                <#if xzq.sumAreaGy==0 && xzq.xzqmc!="合计">
                                                                <#else>
                                                                    <tr>
                                                                        <#if showXzqmc>
                                                                            <#if xzq.xzqmc=="合计">
                                                                        ...
                                                                        <td>${xzq["sumAreaGy"]!?string(fixed)}</td>
                                                                        <#assign areaInfo=xzq.categoryA>
                                                                        <#list areaInfo as item>
                                                                            <#if item["dlbm"]?contains(',')><#else >
                                                                                <td>${item["area_gy"]!?string(fixed)}</td></#if>
                                                                        </#list>
                                                                    </tr>
                                                                </#if>
                                                ...
                                                <div id="tab${dataRow.year!}1jt" class="tab-pane fade">
                                                    <#if firstA??>
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                            ...
                                                            <#list analysisData as xzq>
                                                                <#if xzq.sumAreaJt==0 && xzq.xzqmc!="合计">
                                                                <#else>
                                                                    <tr>
                                                                        <#if showXzqmc>
                                                                            <#if xzq.xzqmc=="合计">
                                                                        ...
                                                                        <td>${xzq["sumAreaJt"]!?string(fixed)}</td>
                                                                        <#assign areaInfo=xzq.categoryA>
                                                                        <#list areaInfo as item>
                                                                            <#if item["dlbm"]?contains(',')><#else >
                                                                                <td>${item["area_jt"]!?string(fixed)}</td></#if>
                                                                        </#list>
                                                                    </tr>
                                                                </#if>
                                                            </#list>
                                                ...
                                                <div id="tab${dataRow.year!}2qb" class="tab-pane fade">
                                                    <#if firstB??>
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                                    <th rowspan="2">行政区名称</th>
                                                                </#if>
                                                                <#if groupBy?? && groupBy=="QSDWDM">
                                                ...
                                                <div id="tab${dataRow.year!}2gy" class="tab-pane fade">
                                                    <#if firstB??>
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                                    <th rowspan="2">行政区名称（国有）</th>
                                                                </#if>
                                                                <#if groupBy?? && groupBy=="QSDWDM">
                                                                    <th rowspan="2">权属单位（国有）</th>
                                                                <#else>
                                                                    <th rowspan="2">坐落单位（国有）</th>
                                                                </#if>
                                                                <th rowspan="2">合计</th>
                                                                <th rowspan="2">耕地(01)</th>
                                                                <th colspan="3">其中</th>
                                                ...
                                                <div id="tab${dataRow.year!}2jt" class="tab-pane fade">
                                                    <#if firstB??>
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                                    <th rowspan="2">行政区名称（集体）</th>
                                                                </#if>
                                                                <#if groupBy?? && groupBy=="QSDWDM">
                                                                    <th rowspan="2">权属单位（集体）</th>
                                                                <#else>
                                                                    <th rowspan="2">坐落单位（集体）</th>
                                                                </#if>
                                                                <th rowspan="2">合计</th>
                                                                <th rowspan="2">耕地(01)</th>
                                                                <th colspan="3">其中</th>
                                                ...
                                                <#if showDetail>
                                                    <div id="tab${dataRow.year!}4" class="tab-pane fade">
                                                        <table>
                                                            <tr>
                                                                <#if showXzqmc>
                                                                    <th>行政区名称</th>
                                                            ...
                                                            <#list dltbData as dltb>
                                                                <tr>
                                                                    ...
                                                                    <td>${dltb["QSXZ"]}</td>
                                                                    <td>${dltb["DLMC"]}</td>
                                                                    <td>${dltb["CCMJ"]?string(fixed)}</td>
                                                                    <td>${dltb["TBMJ"]?string(fixed)}</td>
                                                                    <td>${dltb["ZLDWMC"]}</td>
                                                                </tr>
                                                            </#list>
                                                        </table>
                                        ...
                                        <#if tdlyxzfxBz?? && tdlyxzfxBz == "show">
                                            <div>备注：分析结果需与土地利用现状分类面积表进行对比、核查。</div>
                                        </#if>
                                        <div class="export-container text-center">
                                            ...
                                            <#if data?size gt 1>
                                                ...
                                                <a class="btn btn-primary" onclick="exportExcelS();">多年份对比导出结果</a>
                                            </#if>
                                        </div>
                                    </div>
                                    <#if report??>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //根据选择li标签不同，给隐藏域不同的值（三种不同的值all,gy,jt）默认为all
            var obj_lis = $(".yjfl li");
            for (i = 0; i < obj_lis.length; i++) {
                obj_lis[i].onclick = function () {
                    var content = this.innerHTML;
                    console.log(content);
                    if (content.indexOf("qb") != -1) {
                        $("#flSxzt").val("all");
                    } else if (content.indexOf("gy") != -1) {
                        $("#flSxzt").val("gy");
                    } else if (content.indexOf("jt") != -1) {
                        $("#flSxzt").val("jt");
                    }
                }
            }
        ...
        function exportExcelS() {
            openPostWindow("<@com.rootPath/>/geometryService/export/analysis", JSON.stringify(data), "tdlyxzs.xml");
        }
