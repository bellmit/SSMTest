 ...
 * @description 消息提醒  线上-->线下库
 * @time 2021/04/12 15:04
 */
@Service
public class SendXxtxToXmglServiceImpl implements RabbitTemplate.ConfirmCallback {
    ...
    public void confirm(CorrelationData correlationData, boolean ack, String cause) {
        if (ack) {
            ...
            logger.info("**********消息提醒数据--消息发送失败**********" +
                    Constants.BSDT_XMGL_DIRECT_EXCHANGE + "-" + Constants.BSDT_XMGL_XXTX_QUEUE +
                    "消息发送时间为:" + CalendarUtil.getCurHMSStrDate());
