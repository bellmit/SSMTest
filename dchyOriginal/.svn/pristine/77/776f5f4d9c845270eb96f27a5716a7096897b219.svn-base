		...
		<div class="introduce-detail position-relative">
			<div class="header">
				<div class="header-container">
					<span class="header-title">{{placeSevice}}<span class="font-sun">“</span>多测合一<span class="font-sun">”</span>系统</span>
			...
			<div class="bdc-container">
				<div class="bdc-content">
					<div style="font-size: 38px">{{placeSevice}} “多测合一” 系统</div>
					<p class="line-height-32 margin-top-20 color-content">
						“多测合一”系统，以测绘事项合并为原则，以流程简化、标准统一为方向，以加强事中事后监管为抓手，面向建设单位、测绘单位、管理部门等不同用户，提供在线委托、项目备案、成果入库与共享等各类业务办理服务，实现一次委托，加强成果共享，建立信用评价体系，提高监管效率。</p>
				</div>
			...
			<!-- <div class="bdc-container position-relative">
				<div class="demo-title">
					<div style="font-size: 38px">{{placeSevice}} “多测合一” 系统</div>
					<p class="line-height-32 margin-top-20 color-content">"多测合一"系统基于微服务、云架构，充分利用现有信息化成果，以国土空间信息基础平台、应用基础信息平台为支撑，设置网上办事大厅、项目管理系统、成果管理系统三个业务应用系统，面向建设单位、测绘单位、管理部门等不同用户，提供项目发布、合同备案登记、成果质检、成果入库、成果管理与共享等各类业务办理服务。</p>
				</div>
			</div> -->
		</div>
