 ...
 * @description 推送在线办结数据
 */
@Service
public class SendZxbjToBsdtServiceImpl implements RabbitTemplate.ConfirmCallback {
    ...
    public void sendDirectMsg(String exchange, String routingKey, DchyXmglZxbjDto dchyXmglZxbjDto) {
        ...
        logger.info("线下在线办结数据推送到线上****************************************************************");
        logger.info("线下在线办结返回值数据*************************" + JSONObject.toJSONString(dchyXmglZxbjDto));
    }
