 ...
 * @description TODO 推送线上基础数据申请的数据
 */
@Service
public class SendJcsjToBsdtServiceImpl implements RabbitTemplate.ConfirmCallback {
