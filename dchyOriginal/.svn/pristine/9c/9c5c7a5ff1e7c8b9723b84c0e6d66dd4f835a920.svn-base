...
<div class="container" style="width: 1240px;">
    <div class="row">
        <div style="float:left;margin: 20px">
            <h3 style="font-weight: normal; color:#188074"><span class="icon icon-columns"></span>&nbsp;常州耕地质量等级分析结果展示</h3>
        </div>
...
<script type="text/javascript">
    ...
    function exportExcel(){
        openPostWindow("<@com.rootPath/>/geometryService/export/analysis", result, "czgd_export.xml");
    }
