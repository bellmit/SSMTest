...
import cn.gtmap.msurveyplat.portal.service.CustomUserDetailsService;
...
/*                .and()
    ...
    public CasAuthenticationFilter casAuthenticationFilter() throws Exception {
        ...
        //casAuthenticationFilter.setAuthenticationSuccessHandler(new SimpleUrlAuthenticationSuccessHandler(casProperties.getAppServerUrl() + casProperties.getAppLoginUrl() +".html"));
        casAuthenticationFilter.setAuthenticationSuccessHandler(new MyUrlAuthenticationSuccessHandler(casProperties));
