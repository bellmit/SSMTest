...
!function () {
            ...
            n.forEach(function (n) {
                if ("separator" == n.type) {
                    ...
                    if (l.className = n.className, r.button = l, n.title && (l.title = n.title), n.click && (l.onclick = function () {
                        ...
                        r.ul = m, m.className = "menu", m.style.height = "0", a.appendChild(m), i(m, p, n.submenu)
    ...
    function a(e, t, i) {
        ...
        for (var n = {code: {text: "Code", title: "Switch to code highlighter", click: function () {
            o("code")
    ...
    function l(e, t) {
        ...
        m.title = "Previous result (Shift+Enter)", m.className = "previous", m.onclick = function () {
            i.previous()
        }, r = document.createElement("td"), r.appendChild(m), s.appendChild(r)
    }
    ...
    e.modes = {}, e.prototype._create = function (e, t, i) {
        ...
        this.mode = {edit: "view" != this.options.mode && "form" != this.options.mode, view: "view" == this.options.mode, form: "form" == this.options.mode}
        ...
        i.className = "expand-all", i.title = "展开所有节点", i.onclick = function () {
            e.expandAll()
        }, this.menu.appendChild(i);
        var o = document.createElement("button");
        if (o.title = "关闭所有节点", o.className = "collapse-all", o.onclick = function () {
            e.collapseAll()
        }, this.menu.appendChild(o), this.history) {
            var n = document.createElement("button");
            n.className = "undo separator", n.title = "撤销(Ctrl+Z)", n.onclick = function () {
                e._onUndo()
            }, this.menu.appendChild(n), this.dom.undo = n;
            var s = document.createElement("button");
            s.className = "redo", s.title = "前进 (Ctrl+Shift+Z)", s.onclick = function () {
                e._onRedo()
        ...
        var t, i, s, r, a, l, d, h, c, u, p, m, f, v, g = e.pageY, y = e.pageX, x = !1;
        if (t = this.dom.tr, c = util.getAbsoluteTop(t), m = t.offsetHeight, c > g) {
            i = t;
            do i = i.previousSibling, d = o.getNodeFromTarget(i), u = i ? util.getAbsoluteTop(i) : 0; while (i && u > g);
            d && !d.parent && (d = void 0), d || (l = t.parentNode.firstChild, i = l ? l.nextSibling : void 0, d = o.getNodeFromTarget(i), d == this && (d = void 0)), d && (i = d.dom.tr, u = i ? util.getAbsoluteTop(i) : 0, g > u + m && (d = void 0)), d && (d.parent.moveBefore(this, d), x = !0)
        } else if (a = this.expanded && this.append ? this.append.getDom() : this.dom.tr, r = a ? a.nextSibling : void 0) {
            p = util.getAbsoluteTop(r), s = r;
            do h = o.getNodeFromTarget(s), s && (f = s.nextSibling ? util.getAbsoluteTop(s.nextSibling) : 0, v = s ? f - p : 0, 1 == h.parent.childs.length && h.parent.childs[0] == this && (c += 23)), s = s.nextSibling; while (s && g > c + v);
            if (h && h.parent) {
        ...
        if (13 == a) {
            ...
            if (c) {
                ...
                f && f.focus(o.focusElement || this._getElementName(l)), u = !0
            }
        } else if (36 == a) {
            if (c) {
        ...
        if (r.push({text: "Type", title: "Change the type of this field", className: "type-" + this.type, submenu: [
            {text: "Auto", className: "type-auto" + ("auto" == this.type ? " selected" : ""), title: n.auto, click: function () {
                i._onChangeType("auto")
            }},
            {text: "Array", className: "type-array" + ("array" == this.type ? " selected" : ""), title: n.array, click: function () {
                i._onChangeType("array")
            }},
            {text: "Object", className: "type-object" + ("object" == this.type ? " selected" : ""), title: n.object, click: function () {
                i._onChangeType("object")
            }},
            {text: "String", className: "type-string" + ("string" == this.type ? " selected" : ""), title: n.string, click: function () {
        ...
        this.hide();
        var t = window.innerHeight, i = window.pageYOffset || document.scrollTop || 0, o = t + i, n = e.offsetHeight, r = this.maxHeight, a = util.getAbsoluteLeft(e), l = util.getAbsoluteTop(e);
        o > l + n + r ? (this.dom.menu.style.left = a + "px", this.dom.menu.style.top = l + n + "px", this.dom.menu.style.bottom = "") : (this.dom.menu.style.left = a + "px", this.dom.menu.style.top = "", this.dom.menu.style.bottom = t - l + "px"), document.body.appendChild(this.dom.menu);
        var d = this, h = this.dom.list;
        this.eventListeners.mousedown = util.addEventListener(document, "mousedown", function (e) {
            var t = e.target;
            t == h || d._isChildOf(t, h) || (d.hide(), e.stopPropagation(), e.preventDefault())
