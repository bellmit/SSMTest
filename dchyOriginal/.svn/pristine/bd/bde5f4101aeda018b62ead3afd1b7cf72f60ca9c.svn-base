<template>
    <div class="table upload-ht-table">
...
export default {
    ...
    mounted() {
        ...
        $("#attachmentHtUploadInput").on("change", function () {
            ...
            $(".upload-ht-table tbody .data-type-zone:eq("+_self.curUploadId+") .telescopic-sign-down").show();
    ...
    methods: {
        ...
        // 点击展开
        openPoint(index){
            $(".upload-ht-table tbody .data-type-zone:eq("+index+") .telescopic-sign-right").hide();
            $(".upload-ht-table tbody .data-type-zone:eq("+index+") .telescopic-sign-down").show();
            $(".upload-ht-table tbody .data-file-zone[data-index='"+index+"']").show();
        },
        // 新增
        addNew(){
            this.$emit("tooladd")
        ...
        // 点击收起
        downPoint(index){
            $(".upload-ht-table tbody .data-type-zone:eq("+index+") .telescopic-sign-right").show();
            $(".upload-ht-table tbody .data-type-zone:eq("+index+") .telescopic-sign-down").hide();
            $(".upload-ht-table tbody .data-file-zone[data-index='"+index+"']").hide();
        },
