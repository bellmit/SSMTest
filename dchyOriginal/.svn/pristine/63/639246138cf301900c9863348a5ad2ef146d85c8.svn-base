...
import { queryFile, getFileNums, queryDetailFile } from "../../../service/review"
...
export default {
    ...
    methods: {
        ...
        getTreeData(){
            ...
            queryFile({taskid: this.taskid,gzlslid: this.gzlslid,xmid: this.xmid}).then(res => {
                this.$loading.close();
