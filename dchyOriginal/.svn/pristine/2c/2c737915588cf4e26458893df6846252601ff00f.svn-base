...
--changeset DCHY_XMGL_CHXM:19 failOnError:false runOnChange:true runAlways:false
alter table DCHY_XMGL_CHXM add slrmc VARCHAR2(500);
alter table DCHY_XMGL_CHXM add basj date;
alter table DCHY_XMGL_CHXM add bar VARCHAR2(32);
alter table DCHY_XMGL_CHXM add barmc VARCHAR2(500);
comment on column DCHY_XMGL_CHXM.slrmc is '受理人名称';
comment on column DCHY_XMGL_CHXM.basj is '备案时间';
comment on column DCHY_XMGL_CHXM.bar is '备案人';
comment on column DCHY_XMGL_CHXM.barmc is '备案人名称';
--changeset DCHY_XMGL_CHXM:20 failOnError:false runOnChange:true runAlways:false
alter table DCHY_XMGL_CHXM add fwxz VARCHAR2(2);
comment on column DCHY_XMGL_CHXM.fwxz is '房屋性质';
