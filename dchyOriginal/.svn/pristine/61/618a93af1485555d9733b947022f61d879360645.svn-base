            ...
            <div class="container">
                ...
                <div class="user-form form-edit margin-top-20">
                    <Form :model="registerData" ref="registerForm" @on-validate="validateChecked" :rules="ruleInline" :label-width="142">
                        ...
                        <FormItem v-if="!isSurvey" label="建设单位码" v-model="registerData.jsdwm" prop="jsdwm">
                            <Input v-model="registerData.jsdwm" placeholder="请输入单位名称大写首字母前六位"/>
                        </FormItem>
        ...
        submit(){
            this.$refs["registerForm"].validate(valid => {
                if(valid){
                    ...
                    let registerJsdwm = this.registerData.jsdwm;
                    if(!this.isSurvey&&registerJsdwm.length < 6){
                        let len = registerJsdwm.length
                        let jsdwm = registerJsdwm;
                        for(let i = len; i < 6; i++){
                            jsdwm += '0'
                        }
                        registerJsdwm = jsdwm;
                    ...
                    formData.append("jsdwm", registerJsdwm)
                    ...
                    registerUser(formData).then(res => {
                        ...
                        setTimeout(() => {
                            ...
                            location.href = location.origin + "/portal-ol/yhdwZc/autoLogin?username=" + this.registerData.loginname + "&password=" + this.registerData.password;
                        },1000)
                    })
                }
            })
