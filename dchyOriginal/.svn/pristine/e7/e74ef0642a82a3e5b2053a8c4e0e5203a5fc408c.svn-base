         ...
         <table class="file-data-table">
            <thead>
                <tr>
                    ...
                    <th data-field="attachmentName" v-for="(col,colIndex) in columns" :style="{'width': col.width || 'auto'}"  :key="colIndex">
            ...
            <tbody id="fileTableData" class="form-edit" >
                <template v-for="(item,index) in data">
                    <tr data-index="N" class="data-type-zone" :key="index">
                        ...
                        <td data-field="attachmentName" v-for="(col,colIndex) in columns" :key="colIndex" :style="{'width': col.width || 'auto'}" align="center">
                            <div data-field="5" align="center" data-content="" v-if="col.type == 'operation'" class="position-relative">
                                ...
                                <span class="table-btn-a bdc-delete-btn" v-if="!readonly&&item.WJZXID&&deleted" @click="deleteFj(item)">删除</span>
                            ...
                            <Select v-else-if="!readonly&&col.type=='select'" v-model="item[col.field]">
