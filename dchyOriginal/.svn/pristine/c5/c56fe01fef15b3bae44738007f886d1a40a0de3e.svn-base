...
<div class="container header">
    <h3><span class="icon icon-dashboard"></span>&nbsp;土地利用现状分析结果展示</h3>
                        ...
                        <#if analysisData?size gt 0>
                            ...
                            <div id="basicContainer${dataRow.year!}" class="container basic-container">
                                            ...
                                            <#if firstA??>
                                                <table>
                                                    ...
                                                    <#list analysisData as xzq>
                                                        <tr>
                                                            <#if xzq_index==analysisData?size-1>
                                                                <td rowspan="3"><#if xzq.xzqmc??&&xzq.xzqmc!="null">${xzq["xzqmc"]!}<#else >${xzq["xzqdm"]!}</#if></td>
                                                            <#else>
                                                                <td rowspan="2"><#if xzq.xzqmc??&&xzq.xzqmc!="null">${xzq["xzqmc"]!}<#else >${xzq["xzqdm"]!}</#if></td>
                                                            </#if>
                                                    ...
                                                    <table>
                                                        ...
                                                        <#list analysisData as xzq>
                                                            <tr>
                                                                ...
                                                                <td>国有</td>
                                                                <td>${xzq["sumAreaGy"]!?string(fixed)}</td>
                                                                <td><#if firstB?keys?seq_contains('农用地_gy') >${itemB["农用地_gy"]!?string(fixed)}</#if></td>
                                                                <td><#if firstB?keys?seq_contains('建设用地_gy') >${itemB["建设用地_gy"]!?string(fixed)}</#if></td>
                                                                <td><#if firstB?keys?seq_contains('未利用地_gy') >${itemB["未利用地_gy"]!?string(fixed)}</#if></td>

                                                                <tr>
                                                                    <td>集体</td>
                                                                    <td>${xzq["sumAreaJt"]!?string(fixed)}</td>
                                                                    <td><#if firstB?keys?seq_contains('农用地_jt') >${itemB["农用地_jt"]!?string(fixed)}</#if></td>
                                                                    <td><#if firstB?keys?seq_contains('建设用地_jt') >${itemB["建设用地_jt"]!?string(fixed)}</#if></td>
                                                                    <td><#if firstB?keys?seq_contains('未利用地_jt') >${itemB["未利用地_jt"]!?string(fixed)}</#if></td>
                                                                </tr>
                                                                <#if xzq_index==analysisData?size-1>
                                                                    <tr>
                                                                        <td>合计</td>
                                ...
                                <div class="export-container text-center">
                                    <a class="btn btn-primary" data-excel='${dataRow.exportXls!}' onclick="exportExcel(this,0);">导出excel</a>
                                    <#if dataRow.shpId??>
                                        <a class="btn btn-primary" data-toggle="tooltip" data-placement="bottom"
                                           title="<div style='float:left;'><button class='btn btn-default' data-shpid='${dataRow.shpId!}' onclick='exportFeatures(this,0);'> shp</button>&nbsp;&nbsp;&nbsp;<button class='btn btn-default' data-shpid='${dataRow.shpId!}' onclick='exportFeatures(this,1);'>dwg</button></div>">
                                            导出图形
                                        </a>
                                    </#if>
                                </div>
