<html>
<head>
    <title>Densify Geometries (GeometryServer)</title>
...
<h2>Densify Geometries (GeometryServer)</h2>
<div class='rbody'>
    <form target="_blank" method="post">
        ...
        <td><input type="text" name="maxSegmentLength" value="" /></td>
        </tr>
        <tr>
        <td>Geodesic</td>
        <td>
        <input type="radio" name="geodesic" value="true"/>True&nbsp;
        <input type="radio" name="geodesic" value="false" checked='true'/>False</td>
        </tr>
        <tr>
        <td>Length Unit (WKID):</td>
        <td><input type="text" name="lengthUnit" value="" /></td>
        </tr>
        <tr>
        <tr><td colspan="2"><input type="submit" value="Densify" /></td></tr>
        </table>
    </form>
</div>
</body>
