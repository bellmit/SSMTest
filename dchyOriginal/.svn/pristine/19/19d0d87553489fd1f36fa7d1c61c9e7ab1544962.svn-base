	...
	$(function () {
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.ajax({
					type: "GET",
					url: getContextPath() + "/v1.0/dispatch/order/getSysMenu?useId=" + data.id,
					data: {},
					success: function (data) {
						if (data) {
							data.push({
								...
								childTree: [{
									...
									name: '基本资料',
									mark: 'basic',
									url: '../view/basic-info.html'
								},
								{
									childTree: [],
									name: '修改密码',
									mark: 'update',
									url: '../view/update-pwd.html'
								}
								]
							});
						}
		...
		//跳转成果管理系统
		$('#LAY-system-side-menu').on('click', '#cgglSystem', function () {
			 window.open('../view/management/index.html');
		});
