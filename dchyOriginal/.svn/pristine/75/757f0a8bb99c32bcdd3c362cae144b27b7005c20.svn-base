 ...
 */
@Configuration
@MapperScan(basePackages = {"cn.gtmap.msurveyplat.serviceol.core.mapper", "cn.gtmap.msurveyplat.serviceol.mapper"}, sqlSessionTemplateRef = "sqlSessionTemplate")
...
public class DataBaseConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(
        ...
        bean.setTypeHandlersPackage("cn.gtmap.msurveyplat.serviceol.config.typehandler");
