 ...
 * @description TODO 推送线上受理信息数据
 */
@Service
public class SendSlxxToBsdtServiceImpl implements RabbitTemplate.ConfirmCallback {
    ...
    public void sendDirectMsg(String exchange, String routingKey, DchyXmglChxmDto dchyXmglChxmDto) {
            ...
            logger.info("线下受理信息数据(chxmDto)推送到线上****************************************************************");
        }
