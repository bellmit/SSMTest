                ...
                <Row>
                    <i-col span="6">
                        <FormItem label="测绘单位 " class="form-list-search" prop="dwmc">
                            <Input type="text" class="form-search-item" @keydown.enter.native.prevent="getMlkDbList(1,formInline.size)" v-model="formInline.dwmc" placeholder=""/>
                        </FormItem>
                    </i-col>
                    <i-col span="10">
                    ...
                    <i-col span="6">
                        <FormItem :label-width='20'>
                            <Button type="primary" class="btn-h-32 bdc-major-btn" @click="getMlkDbList(1,formInline.size)">查询</Button>
...
<script>
import { getMlkDbList } from "../../../service/review"
...
export default {
    ...
    methods: {
        ...
        getMlkDbList(page,size){
            ...
            getMlkDbList(this.formInline).then(res => {
                this.$loading.close();
