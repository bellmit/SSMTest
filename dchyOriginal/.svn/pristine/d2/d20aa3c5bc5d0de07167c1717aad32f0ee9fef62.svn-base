                ...
                <Row>
                    <i-col span="6">
                        <FormItem label="项目编号 " class="form-list-search" prop="babh">
                            <Input type="text" class="form-search-item" @keydown.enter.native.prevent="getEntrustList(1,formInline.pageSize)" v-model="formInline.babh" placeholder=""/>
                        </FormItem>
                    </i-col>
                    <i-col span="6">
                    ...
                    <i-col span="6">
                        <FormItem label="工程名称 " class="form-list-search" prop="gcmc">
                            <Input type="text" class="form-search-item" @keydown.enter.native.prevent="getEntrustList(1,formInline.pageSize)" v-model="formInline.gcmc" placeholder=""/>
                        </FormItem>
                    </i-col>
                    <i-col span="6">
...
<script>
import { getJsdwProjectList, chdwHtDownload } from "../../../service/myproject"
    ...
    methods: {
       ...
       getEntrustList(page,pageSize){
        ...
        edit(data){
            ...
            let params = {
                ssmkid: data.XMLY == '2' ? "8" : "22",
                glsxid: data.CHXMID
            }
            this.editSsmkid = data.XMLY == '2' ? "8" : "22";
            let htxxidList = [];
            // 获取需要上传的文件
        ...
        cancel(){
            ...
            if(hasUpload){
                let params = {
                    ssmkid: this.selectChxm.XMLY == '2' ? '8' : '22',
