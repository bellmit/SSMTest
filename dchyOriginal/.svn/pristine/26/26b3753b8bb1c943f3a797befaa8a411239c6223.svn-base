...
import cn.gtmap.msurveyplat.serviceol.core.xsbfmapper.DchyXmglChxmXSBFMapper;
import cn.gtmap.msurveyplat.serviceol.service.ExportPdfService;
import cn.gtmap.msurveyplat.serviceol.utils.Constants;
import cn.gtmap.msurveyplat.serviceol.utils.PdfReport;
import cn.gtmap.msurveyplat.serviceol.utils.Watermark;
...
public class ExportPdfServiceImpl implements ExportPdfService {
    ...
    static {
        try {
            // 获取路径地址
            modelPath = AppConfig.getProperty("egov.conf") + "serviceol/";
    ...
    @Autowired
    private DchyXmglChxmXSBFMapper dchyXmglChxmMapper;
